...
---------------------
- Add sprites, audio, and more entities
- Add a small config for controls and settings
- Package a self-contained Linux build (I can't run Unity builds here, but I can produce the MonoGame build files you can run with dotnet/publish locally)

If you want me to continue, tell me which feature to add next (audio, more entities, better room generation, or packaging).
